...
function test_mixed_ships_speed()
    ...
    local s2 = ship.create(r, "longboat") -- speed 3
    local u1 = unit.create(f, r, 4)
...
function test_mixed_ships_landing()
    ...
    local f = faction.create("noreply@eressea.de", "human", "de")
    local s1 = ship.create(r2, "boat")  -- can land in a glacier
    local s2 = ship.create(r2, "longboat") -- can not land in a glacier
...
function test_boat_landing()
    ...
    local f = faction.create("noreply@eressea.de", "human", "de")
    local s1 = ship.create(r2, "boat") -- can land in a glacier
    local s2 = ship.create(r2, "boat") -- can land in a glacier
